...
<svelte:head>
  ...
  <meta name="description" content="Prehľad Pythonu pre maturitné skúšky — rýchla referencia a detailné príklady." />
</svelte:head>
    ...
    <div class="header-inner container">
      ...
      <nav class="tab-nav" role="tablist" aria-label="Zobrazenie">
        <button
          ...
          on:click={() => { activeTab = 'quick'; expandedId = null; }}
        >
        ...
        <button
          ...
          on:click={() => { activeTab = 'detail'; expandedId = null; }}
        >
          <span class="tab-icon">📚</span>
          Detailný prehľad
        </button>
  ...
  <div class="filters-bar">
    <div class="filters-inner container">
      <div class="search-wrap">
        ...
        />
        {#if searchQuery}
          <button class="search-clear" on:click={() => searchQuery = ''} aria-label="Vymazať hľadanie">✕</button>
        {/if}
      </div>

      <div class="cat-scroll" role="group" aria-label="Kategórie">
        <button
          class="cat-btn"
  ...
  <main class="main container">
    ...
    {:else if activeTab === 'quick'}
      <div class="result-count">
        ...
        {#if searchQuery || selectedCategory !== 'all'}<span class="result-filter">— filtrované</span>{/if}
      </div>
          ...
          >
            ...
            {#if expandedId === entry.id}
              <div class="quick-expand">
                ...
                <pre class="code-block"><code>{entry.example}</code></pre>
              </div>
            {/if}
          </article>
        {/each}
...
<style lang="scss">
  ...
  .result-count {
    ...
    .result-filter { color: var(--accent-blue); }
  }
  ...
  .quick-card {
    ...
    &:hover {
      ...
      box-shadow: 0 0 0 3px rgba(var(--cat-accent-rgb, 59,130,246), 0.08), $shadow-sm;
      transform: translateY(-1px);
    }

    &.expanded {
      border-color: var(--cat-accent);
      box-shadow: 0 0 0 3px rgba(59,130,246,0.1), $shadow-md;
    }
  }
